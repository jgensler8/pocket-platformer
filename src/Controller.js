import { DrawSectionHandler } from "./handlers/DrawSectionHandler";
import { WorldDataHandler } from './handlers/WorldDataHandler';
...
export class Controller {
    ...
    */
    ...
    static mouseMove(e) {
        const coordinatesWithoutTranslation = Camera.worldToScreen(e.clientX - window.canvasOffsetLeft, 
    ...
    static onResize() {
        window.canvasOffsetLeft = document.getElementById("myCanvas").offsetLeft;
        window.canvasOffsetTop = document.getElementById("myCanvas").offsetTop;
    }
