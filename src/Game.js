...
import { ObjectsTooltipElementsRenderer } from './htmlRenderers/ObjectsTooltipElementsRenderer';
import { LevelSizeHandler } from './handlers/LevelSizeHandler';
...
export class Game {
    ...
    static executeGameMode() {
        if (this.playMode === this.PLAY_MODE) {
            ...
            window.requestAnimationFrame(window.play);
        }
