...
export class BuildMode {
    ...
    static showTooltipWithExtraAttributes(tilePosX, tilePosY, currentObject) {
        ...
        const xPos = window.canvasOffsetLeft + (tilePosX * this.tileMapHandler.tileSize) - 120 - Camera.viewport.left;
        const yPos = window.canvasOffsetTop + (tilePosY * this.tileMapHandler.tileSize) + this.tileMapHandler.tileSize + 6 - Camera.viewport.top;
