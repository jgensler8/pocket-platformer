...
export class Camera {
    ...
    static updateViewportRelatedToScale(scale) {
        ...
        window.player.x && window.player.y && this.followObject(window.player.x, window.player.y);
    ...
    static followObject(x, y) {
        ...
        */
        ...
        if(window.tileMapHandler.levelHeightInPx - this.viewport.height > window.tileMapHandler.tileSize - 1) {
            changingYNecessary = true
        }
        if(window.tileMapHandler.levelWidthInPx - this.viewport.width > window.tileMapHandler.tileSize - 1) {
